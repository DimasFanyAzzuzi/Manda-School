...
<!-- Mirrored from demos.creative-tim.com/argon-dashboard-pro/pages/calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Nov 2021 18:27:17 GMT -->
    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="../pages/examples/dashboard.php" class="nav-link">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../pages/examples/profile.php"> 
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-forms">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="../forms/absen.php" class="nav-link">
                      <span class="sidenav-mini-icon"> E </span>
                      <span class="sidenav-normal"> Absen </span>
                    </a>
                  </li>
                  <!-- <li class="nav-item">
                    <a href="../forms/edit-absen.php" class="nav-link">
                      <span class="sidenav-mini-icon"> C </span>
                      <span class="sidenav-normal"> Edit Absen </span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../forms/validasi.php" class="nav-link">
                      <span class="sidenav-mini-icon"> V </span>
                      <span class="sidenav-normal"> Validasi </span>
                    </a>
                  </li> -->
                </ul>
              </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-tables">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="../pages/tables/daftar-guru.php" class="nav-link">
                      <span class="sidenav-mini-icon"> T </span>
                      <span class="sidenav-normal"> Daftar Guru </span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../pages/tables/daftar-murid.php" class="nav-link">
          ...
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link" href="../pages/examples/profile.php" target="_blank">
                <i class="ni ni-single-02"></i>
                <span class="nav-link-text">Edit Profile</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../pages/examples/logout.php">
...
<!-- Mirrored from demos.creative-tim.com/argon-dashboard-pro/pages/calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Nov 2021 18:27:18 GMT -->
</html>