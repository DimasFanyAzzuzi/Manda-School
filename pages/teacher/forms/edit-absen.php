          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Edit Absen </h3>
                </div>
              </div>
            </div>
            <div class="card-body">
            <?php
              $idAbsen = $_GET['id_absen'];

              $SelectData = mysqli_query($koneksi, "SELECT * FROM tbl_absen WHERE id_absen = '$idAbsen'");
              $GetData = mysqli_fetch_array($SelectData);
            ?>
              <form action="../../examples/update-absen.php" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
                <input type="hidden" name="id_absen" value="<?php echo $idAbsen; ?>"></input>
                  ...
                  <div class="row"> 
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input id="input-time" class="form-control" name="id_guru_mapel" type="text" placeholder="Kode Guru Mapel" value="<?php echo $GetData['id_guru_mapel']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="date" id="input-last-name" class="form-control" name="tgl_absen" placeholder="Date" value="<?php echo $GetData['tgl_absen']?>">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input id="input-time" class="form-control" name="start_time" type="time" value="<?php echo $GetData['start_time']?>">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Akhir Absen</label>
                        <input id="input-time" class="form-control" name="end_time" type="time" value="<?php echo $GetData['end_time']?>">
                      </div>
                    </div>
                  </div>
