        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Laporan Absen</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="absen.php">Data Absen</a></li>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Tambah Absen </h3>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form action="../../examples/insert-data-absen.php" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
                <h6 class="heading-small text-muted mb-4">Data Absen</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Kode Guru Mapel</label>
                        <input id="input-time" class="form-control" name="id_guru_mapel" type="text" placeholder="Kode Guru Mapel">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label for="Nama">Kelas Jurusan</label>
                          ...
                          <?php 
                            $GetTableMapel = mysqli_query($koneksi, "SELECT * FROM tbl_jurusan_kelas");
                            while ($GetDataMapel = mysqli_fetch_array($GetTableMapel)) {
                              echo "
                                <option value='$GetDataMapel[id_jurusan_kelas]'>$GetDataMapel[nama_jurusan_kelas]</option>
                              ";
                            }
                          ?>
										    </select>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Tanggal Absen</label>
                        <input type="date" id="input-last-name" class="form-control" name="tgl_absen" placeholder="Date">
                      </div>
                    </div>
                  </div>
                </div>
                <hr class="my-4" />
                <!-- Address -->
                <h6 class="heading-small text-muted mb-4">Waktu Absen</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Mulai Absen</label>
                        <input id="input-time" class="form-control" name="start_time" type="time" value="<?php date_default_timezone_set('Asia/Jakarta');
                        echo date('H:i'); ?>
                        ">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Akhir Absen</label>
                        <input id="input-time" class="form-control" name="end_time" type="time" value="<?php date_default_timezone_set('Asia/Jakarta');
                        echo date('H:i'); ?>
                        ">
                      </div>
                    </div>
