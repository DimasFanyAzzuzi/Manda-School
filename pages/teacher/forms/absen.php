  ...
  <div class="main-content" id="panel">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="tambah-absen.php" class="btn btn-sm btn-success">Tambah Absen</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Page content -->
      <div class="card">
        ...
        $GetTable = mysqli_query($koneksi, "SELECT tbl_absen.*, tbl_jurusan_kelas.nama_jurusan_kelas FROM tbl_absen INNER JOIN tbl_jurusan_kelas ON tbl_absen.id_jurusan_kelas = tbl_jurusan_kelas.id_jurusan_kelas
        ");
        while ($GetData = mysqli_fetch_array($GetTable)) {
            echo "
                <tr>
                    <td>$GetData[id_absen]</td>
                    <td>$GetData[id_guru_mapel]</td>
                    <td>$GetData[nama_jurusan_kelas]</td>
                    <td>$GetData[start_time]</td>
                    <td>$GetData[end_time]</td>
                    <td>$GetData[tgl_absen]</td>
                    <td>
                    <a href='edit-absen.php?id_absen=$GetData[id_absen]'class='table-action' data-toggle='tooltip' data-original-title='Edit Absen'>
                    <i class='fas fa-user-edit'></i>
                    </a>
                    <a href='hapus-absen.php?id_absen=$GetData[id_absen]'class='table-action table-action-delete' data-toggle='tooltip' data-original-title='Delete Absen'>
