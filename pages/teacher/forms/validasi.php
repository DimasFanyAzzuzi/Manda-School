            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="validasi.php">Laporan Absen</a></li>
            ...
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-buttons">
                ...
                <?php
                    ...
                    $GetTable = mysqli_query($koneksi, "SELECT tbl_absen.*, tbl_siswa.nama_siswa, tbl_jurusan_kelas.nama_jurusan_kelas FROM tbl_absen INNER JOIN tbl_siswa ON tbl_absen.id_siswa = tbl_siswa.id_siswa INNER JOIN tbl_jurusan_kelas ON tbl_absen.id_jurusan_kelas = tbl_jurusan_kelas.id_jurusan_kelas
                    ");
