            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Biodata Guru</li>
                </ol>
              </nav>
            </div>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <?php
                    require '../../examples/koneksi.php';
                    $id = $_SESSION['ID'];
                    $GetDataFoto = mysqli_query($koneksi, "SELECT * FROM tbl_guru where id_guru = '$id'");
                    while($GetData = mysqli_fetch_array($GetDataFoto)) {
                      echo "
                      <div class='card-profile-image'>
                      <a href='#'>
                        <img src='../../../assets/img/profil/$GetData[image_guru]' class='rounded-circle'>
                      </a>
                    </div>
                      ";
                    }
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Biodata Guru </h3>
                </div>
              </div>
            </div>
            <div class="card-body">
            <form action="update-profil.php" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
                <input type="hidden" name="id_guru" value="<?php echo $_SESSION['ID']; ?>"></input>
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" name="nama_guru" placeholder="Maksimal 30 kata" value="<?php echo $_SESSION['Name']?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">NIP</label>
                        <input type="text" id="input-nip" class="form-control" name="nip" placeholder="Maksimal 20 angka" value="<?php echo $_SESSION['NIP']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-nip" class="form-control" name="jenis_kelamin" placeholder="Maksimal 20 angka" value="<?php echo $_SESSION['JK']?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Tanggal Lahir</label>
                        <input type="date" id="input-last-name" class="form-control" name="tgl_lahir" placeholder="Date" value="<?php echo $_SESSION['TL']?>">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" name="alamat" placeholder="Jln. Argopouro No. 55 Desa, Kec., Kab." type="text" value="<?php echo $_SESSION['Am']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" name="password_guru" placeholder="*****" type="text" value="<?php echo $_SESSION['PW']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" class="form-control" name="no_hp" placeholder="08**********" value="<?php echo $_SESSION['HP']?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Kode Mata Pelajaran</label>
                        <input type="text" id="input-nip" class="form-control" name="id_mapel" placeholder="Maksimal 20 angka" value="<?php echo $_SESSION['Mpl']?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Kode Admin</label>
                        <input type="text" id="input-nip" class="form-control" name="id_admin" placeholder="Maksimal 20 angka" value="<?php echo $_SESSION['Adm']?>">
                      </div>
                    </div>
                  </div>
                </div>
