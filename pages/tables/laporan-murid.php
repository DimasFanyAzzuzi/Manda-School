  ...
  <div class="main-content" id="panel">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Laporan Murid</li>
                </ol>
              </nav>
            </div>
          </div>
    ...
    <div class="container-fluid mt--6">
      ...
      <div class="row">
        ...
        $Number = 1;
        $GetTable = mysqli_query($koneksi, "SELECT tbl_siswa.*, tbl_jurusan_kelas.nama_jurusan_kelas FROM tbl_siswa INNER JOIN tbl_jurusan_kelas ON tbl_siswa.id_jurusan_kelas = tbl_jurusan_kelas.id_jurusan_kelas
        ");
