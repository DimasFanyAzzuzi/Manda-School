      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form action="../examples/insert-data.php" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" name="nama_guru" placeholder="Maksimal 30 kata">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">NIP</label>
                        <input type="text" id="input-email" class="form-control" name="nip" placeholder="Maksimal 20 angka">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="date" id="input-last-name" class="form-control" name="tgl_lahir" placeholder="Date">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" name="alamat" placeholder="Jln. Argopouro No. 55 Desa, Kec., Kab." type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" name="password_guru" placeholder="*****" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" class="form-control" name="no_hp" placeholder="08**********">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label for="Nama">Mata Pelajaran</label>
                          ...
                          <?php 
                            $GetTableMapel = mysqli_query($koneksi, "SELECT * FROM tbl_mapel");
                            while ($GetDataMapel = mysqli_fetch_array($GetTableMapel)) {
                              echo "
                                <option value='$GetDataMapel[id_mapel]'>$GetDataMapel[nama_mapel]</option>
                              ";
                            }
                          ?>
										    </select>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-postal-code" class="form-control" name="id_admin" placeholder="Kode Admin">
                      </div>
                    </div>
                  </div>
                </div>
                <hr class="my-4" />
                <!-- Description -->
                <h6 class="heading-small text-muted mb-4">Masukkan Foto Profile</h6>
                <div class="col-md-12">
									<div class="form-group">
										<label>Foto*</label>
										<div class="input-group mb-3">
											<div class="custom-file">
												<input type="file" class="custom-file-input" name="image_guru">
