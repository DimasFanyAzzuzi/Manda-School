  ...
  <div class="main-content" id="panel">
    ...
    <div class="header bg-gradient-green pb-6">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Daftar Murid</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="tambah-data-murid.php" class="btn btn-sm btn-success">Tambah Data</a>
              <!-- <a href="#" class="btn btn-sm btn-success">Filters</a> -->
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        $Number = 1;
        $GetTable = mysqli_query($koneksi, "SELECT tbl_siswa.*, tbl_jurusan_kelas.nama_jurusan_kelas, tbl_admin.fullname FROM tbl_siswa INNER JOIN tbl_jurusan_kelas ON tbl_siswa.id_jurusan_kelas = tbl_jurusan_kelas.id_jurusan_kelas INNER JOIN tbl_admin ON tbl_siswa.id_admin = tbl_admin.id_admin
        ");
        while ($GetData = mysqli_fetch_array($GetTable)) {
            echo "
                <tr>
                    <td>" . $Number++ . "</td>
                    <td class='table-user'>
                    <img src='../../aasets/img/profil-murid/$GetData[image_siswa]' class='avatar rounded-circle mr-3'></td>
                    <td>$GetData[nama_siswa]</td>
                    <td>$GetData[alamat]</td>
                    <td>$GetData[tgl_lahir]</td>
                    <td>$GetData[jenis_kelamin]</td>
                    <td>$GetData[nisn]</td>
                    <td>$GetData[password_siswa]</td>
                    <td>$GetData[no_hp]</td>
                    <td>$GetData[nama_jurusan_kelas]</td>
                    <td>$GetData[fullname]</td>
                    <td>
                    <a href='edit-data-murid.php?id_siswa=$GetData[id_siswa]'class='table-action' data-toggle='tooltip' data-original-title='Edit Data'>
                    <i class='fas fa-user-edit'></i>
                    </a>
                    <a href='hapus-data-murid.php?id_siswa=$GetData[id_siswa]'class='table-action table-action-delete' data-toggle='tooltip' data-original-title='Delete Data'>
