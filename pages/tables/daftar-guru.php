  ...
  <div class="main-content" id="panel">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="tambah-data.php" class="btn btn-sm btn-success">Tambah Data</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Page content -->
      <div class="card">
        ...
        $Number = 1;
        $GetTable = mysqli_query($koneksi, "SELECT tbl_guru.*, tbl_mapel.nama_mapel, tbl_admin.fullname FROM tbl_guru INNER JOIN tbl_mapel ON tbl_guru.id_mapel = tbl_mapel.id_mapel INNER JOIN tbl_admin ON tbl_guru.id_admin = tbl_admin.id_admin
        ");
        while ($GetData = mysqli_fetch_array($GetTable)) {
            echo "
                <tr>
                    <td>" . $Number++ . "</td>
                    <td class='table-user'>
                    <img src='../../assets/img/profil/$GetData[image_guru]' class='avatar rounded-circle mr-3'></td>
                    <td>$GetData[nama_guru]</td>
                    <td>$GetData[jenis_kelamin]</td>
                    <td>$GetData[no_hp]</td>
                    <td>$GetData[tgl_lahir]</td>
                    <td>$GetData[nip]</td>
                    <td>$GetData[password_guru]</td>
                    <td>$GetData[alamat]</td>
                    <td>$GetData[nama_mapel]</td>
                    <td>$GetData[fullname]</td>
                    <td>
                    <a href='edit-data-guru.php?id_guru=$GetData[id_guru]'class='table-action' data-toggle='tooltip' data-original-title='Edit Data'>
                    <i class='fas fa-user-edit'></i>
                    </a>
                    <a href='hapus-data-guru.php?id_guru=$GetData[id_guru]'class='table-action table-action-delete' data-toggle='tooltip' data-original-title='Delete Data'>
