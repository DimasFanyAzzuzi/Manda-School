      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form action="../examples/insert-data-murid.php" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" name="nama_siswa" placeholder="Maksimal 30 kata">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">NISN</label>
                        <input type="text" id="input-email" class="form-control" name="nisn" placeholder="Maksimal 20 angka">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" name="password_siswa" placeholder="*****" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
									...
									<div class="form-group">
										...
										<div class="input-group mb-3">
											<div class="custom-file">
												<input type="file" class="custom-file-input" name="image_siswa">
