        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <?php
              ...
              $SelectData = mysqli_query($koneksi, "SELECT * FROM tbl_guru WHERE id_guru = '$idGuru'");
              $GetData = mysqli_fetch_array($SelectData);
            ?>
              <form action="../examples/update-data.php" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
                <input type="hidden" name="id_guru" value="<?php echo $idGuru; ?>"></input>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" name="nama_guru" placeholder="Maksimal 30 kata" value="<?php echo $GetData['nama_guru']?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">NIP</label>
                        <input type="text" id="input-nip" class="form-control" name="nip" placeholder="Maksimal 20 angka" value="<?php echo $GetData['nip']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" name="password_guru" placeholder="*****" type="text" value="<?php echo $GetData['password_guru']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                        ...
                        <label for="Nama">Mata Pelajaran</label>
                          ...
                          <?php 
                            ...
                            while ($GetDataMapel = mysqli_fetch_array($GetTableMapel)) {
                              if($GetData['id_mapel'] == $GetDataMapel['id_mapel']) {
                                $terpilih = "selected"; 
                              }else {
                                $terpilih = "";
                              }
                              echo "
                                <option value='$GetDataMapel[id_mapel]' $terpilih>$GetDataMapel[nama_mapel]</option>
                              ";
                            }
                          ?>
										    </select>
