            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0"><a href="../tables/daftar-murid.php">Total Murid</a></h5>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0"><a href="../tables/daftar-guru.php">Total Guru</a></h5>
                      <span class="h2 font-weight-bold mb-0">
                      <?php
                          include 'koneksi.php';
